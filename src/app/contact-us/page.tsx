...
export default function ContactPage() {
  useEffect(() => {
    document.title = "Contact Us - S3B Global";
  }, []);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background font-sans antialiased overflow-x-hidden selection:bg-primary/30 selection:text-white transition-colors duration-300">
      ...
      {/* Main Page Layout */}
      <main className="flex-1 w-full pt-20 md:pt-24 bg-background text-foreground transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-8 md:pt-10 pb-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-stretch">

            {/* Left Column: Headline, copy, and secondary CTA (6 columns) */}
            <ScrollReveal className="lg:col-span-6 text-left space-y-6 lg:pr-8 flex flex-col justify-center items-start">
              ...
              <div className="space-y-6 pt-6 border-t border-card-border/40 select-none">
                <div className="flex items-start space-x-3.5 text-[16px] md:text-[17px] font-normal">
                  <MapPin className="h-5 w-5 md:h-[22px] md:w-[22px] text-[#1d70b8] shrink-0 mt-1" />
                  <div className="space-y-4 text-[16px] md:text-[17px] font-normal">
                    <div className="space-y-1.5">
                      <span className="text-[16px] md:text-[17px] font-light text-[#0f2d59] dark:text-text-title block">US Office Address:</span>
                      <span className="leading-relaxed text-black dark:text-zinc-300 block font-light">
                        8000 Avalon Boulevard Suites 100 and 200, Alpharetta, GA 30009, United States
                      </span>
                    </div>
                    <div className="space-y-1.5">
                      <span className="text-[16px] md:text-[17px] font-light text-[#0f2d59] dark:text-text-title block">India Office Address:</span>
                      <span className="leading-relaxed text-black dark:text-zinc-300 block font-light">
                ...
                <div className="flex items-start space-x-3.5 text-[16px] md:text-[17px] font-normal">
                  <Mail className="h-5 w-5 md:h-[22px] md:w-[22px] text-[#1d70b8] shrink-0 mt-1" />
                  <div className="space-y-1.5 flex-1">
                    <span className="text-[16px] md:text-[17px] font-light text-[#0f2d59] dark:text-text-title block">Email:</span>
                    <span className="leading-relaxed text-black dark:text-zinc-300 block font-light">
            ...
            {/* Right Column: Contact Form Panel (6 columns) */}
            <ScrollReveal delay={150} className="lg:col-span-6 bg-card-bg border border-card-border px-8 py-6 md:px-10 md:py-8 lg:px-12 lg:py-8 rounded-3xl backdrop-blur-md shadow-sm text-left relative overflow-hidden transition-all duration-300 hover:shadow-md flex flex-col justify-center">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleFormSubmit} className="space-y-6 lg:space-y-7">
                  {/* First and Last Name row */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5">
                    <div className="space-y-2">
                      <label className="text-[14px] md:text-[15px] font-semibold text-text-title block">First Name <span className="text-red-500">*</span></label>
                      <input
                        id="first-name-input"
                        type="text"
                        ...
                        className="w-full px-4 py-3.5 rounded-xl border bg-slate-100/90 dark:bg-black/20 text-[14px] md:text-[15px] font-normal text-text-title placeholder-text-muted/75 focus:outline-none transition-all border-slate-200 dark:border-card-border focus:border-[#1d70b8]"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[14px] md:text-[15px] font-semibold text-text-title block">Last Name <span className="text-red-500">*</span></label>
                      <input
                        type="text"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5">
                    <div className="space-y-2">
                      <label className="text-[14px] md:text-[15px] font-semibold text-text-title block">Email Address <span className="text-red-500">*</span></label>
                      <input
                        type="email"
                    ...
                    <div className="space-y-2">
                      <label className="text-[14px] md:text-[15px] font-semibold text-text-title block">Phone<span className="text-red-500">*</span></label>
                      <input
                        type="tel"
                        placeholder="Phone"
                        value={phone}
                  ...
                  <div className="space-y-2">
                    <label className="text-[14px] md:text-[15px] font-semibold text-text-title block">Comments / Questions <span className="text-red-500">*</span></label>
                    <textarea
                      rows={5}
        ...
        <div className="w-full border-y border-card-border/60 bg-card-bg/25 backdrop-blur-sm py-8 overflow-hidden select-none relative z-10">
